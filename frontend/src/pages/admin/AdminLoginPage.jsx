...
const AdminLoginPage = () => {
  ...
  return (
    <section className="flex min-h-screen items-center justify-center bg-boutique-background px-4 py-12">
      <div className="grid w-full max-w-5xl gap-8 lg:grid-cols-[0.95fr,1.05fr]">
        <div className="rounded-[2rem] bg-boutique-maroon p-8 text-white shadow-luxe">
          ...
          <h1 className="mt-6 font-display text-5xl">Control the boutique experience with precision.</h1>
